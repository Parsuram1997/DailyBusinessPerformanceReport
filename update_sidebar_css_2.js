...
const newCss = `/* Sidebar Hover Expansion Styles */
        #sidebar { 
...
for (const f of files) {
    ...
    // Replace everything between /* Sidebar Hover Expansion Styles */ and /* Hide number input arrows */
    const startMarker = '/* Sidebar Hover Expansion Styles */';
    const endMarker = '/* Hide number input arrows */';
